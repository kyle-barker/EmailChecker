...
ASTs.forEach(ast => {
    ast.walkRules(rule => {
        ...
        if (selector.includes(":active")) {
            rules["css-pseudo-class-active"] = true;
        }
        if (selector.includes(":checked")) {
            rules["css-pseudo-class-checked"] = true;
        }
        if (selector.includes(":first-child")) {
            rules["css-pseudo-class-first-child"] = true;
        }
        if (selector.includes(":first-of-type")) {
            rules["css-pseudo-class-first-of-type"] = true;
        }
        if (selector.includes(":focus")) {
            rules["css-pseudo-class-focus"] = true;
        }
        if (selector.includes(":hover")) {
            rules["css-pseudo-class-hover"] = true;
        }
        if (selector.includes(":last-child")) {
            rules["css-pseudo-class-last-child"] = true;
        }
        if (selector.includes(":last-of-type")) {
            rules["css-pseudo-class-last-of-type"] = true;
        }
        if (selector.includes(":link")) {
            rules["css-pseudo-class-link"] = true;
        }
        if (selector.includes(":not")) {
            rules["css-pseudo-class-not"] = true;
        }
        if (selector.includes(":nth-child")) {
            rules["css-pseudo-class-nth-child"] = true;
        }
        if (selector.includes(":nth-last-child")) {
            rules["css-pseudo-class-nth-last-child"] = true;
        }
        if (selector.includes(":nth-last-of-type")) {
            rules["css-pseudo-class-nth-last-of-type"] = true;
        }
        if (selector.includes(":nth-of-type")) {
            rules["css-pseudo-class-nth-of-type"] = true;
        }
        if (selector.includes(":only-child")) {
            rules["css-pseudo-class-only-child"] = true;
        }
        if (selector.includes(":only-of-type")) {
            rules["css-pseudo-class-only-of-type"] = true;
        }
        if (selector.includes(":target")) {
            rules["css-pseudo-class-target"] = true;
        }
        if (selector.includes(":visited")) {
            rules["css-pseudo-class-visited"] = true;
        }
        if (selector.includes("::after")) {
            rules["css-pseudo-element-after"] = true;
        }
        if (selector.includes("::before")) {
            rules["css-pseudo-element-before"] = true;
        }
        if (selector.includes("::first-letter")) {
            rules["css-pseudo-element-first-letter"] = true;
        }
        if (selector.includes("::first-line")) {
            rules["css-pseudo-element-first-line"] = true;
        }
        if (selector.includes("::marker")) {
            rules["css-pseudo-element-marker"] = true;
        }
        if (selector.includes("::placeholder")) {
            rules["css-pseudo-element-placeholder"] = true;
        }
        if (selector.includes("+")) {
            rules["css-selector-adjacent-sibling"] = true;
        }
        if (selector.includes("[")) {
            rules["css-selector-attribute"] = true;
        }
